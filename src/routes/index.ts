...
/** Admin — Invitations */
router.post(
  "/api/surveys/:id/invitations/send",
  authenticate,
  invitationController.sendInvitations,
);
router.get(
  "/api/surveys/:id/invitations",
  authenticate,
  invitationController.listInvitations,
);
router.get(
  "/api/surveys/:id/invitations/preview",
  authenticate,
...
router.get(
  ...
  authenticate,
  resultController.getSummary,
);
router.get(
  "/api/surveys/:id/results/questions",
  authenticate,
  resultController.getQuestionStats,
);
router.get(
  "/api/surveys/:id/results/comments",
  authenticate,
  resultController.getComments,
);
router.get(
  "/api/surveys/:id/results/export.csv",
  authenticate,
  resultController.exportCsv,
);
...
router.post(
  ...
  publicController.submitResponse,
);
